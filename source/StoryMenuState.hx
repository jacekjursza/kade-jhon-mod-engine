	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				...
				//FlxG.switchState(new VideoState('assets/videos/fortniteballs.webm', new PlayState()));
				// https://githubmemory.com/repo/KadeDev/Friday-Night-Funkin-Mp4-Video-Support
