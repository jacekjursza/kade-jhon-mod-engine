	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'monster':
				...
				playAnim('idle');
			case 'jhon':
					tex = Paths.getSparrowAtlas('jhon','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'jhon idle', 5, false);
					animation.addByPrefix('singUP', 'jhon up', 4, false);
					animation.addByPrefix('singDOWN', 'jhon down', 4, false);
					animation.addByPrefix('singLEFT', 'jhon left', 4, false);
					animation.addByPrefix('singRIGHT', 'jhon right', 4, false);
	
					loadOffsetFile(curCharacter);
					playAnim('idle');	
			case 'jhon-Chad':
					tex = Paths.getSparrowAtlas('jhon-Chad','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'Jhon-Chad idle', 3, false);
					// animation.addByPrefix('singUP', 'Jhon-Chad up', 3, false);
					// animation.addByPrefix('singDOWN', 'Jhon-Chad down', 3, false);
					// animation.addByPrefix('singLEFT', 'Jhon-Chad left', 3, false);
					// animation.addByPrefix('singRIGHT', 'Jhon-Chad right', 3, false);
	
					loadOffsetFile(curCharacter);
					playAnim('idle');
			case 'matt':
				tex = Paths.getSparrowAtlas('matt','shared',true);
				frames = tex;
