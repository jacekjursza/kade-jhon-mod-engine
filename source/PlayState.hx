...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'cheese':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/cheese/cheeseDialogue'));				
			case 'clean':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/clean/cleanDialogue'));	
			case 'ass':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/ass/assDialogue'));					
				...
				case 'jhon':
					{
						...
						var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('jhons_house', 'week7'));
						var bg2:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('jhons_floor', 'week7'));
						if(FlxG.save.data.antialiasing)
							{
		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					video.playMP4(Paths.video('Cutscenejhon'), new PlayState()); 
